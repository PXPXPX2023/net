#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex196e52.sh (The Apex Vanguard - Project Genesis V196e52)
# 快捷方式: xrv
# 【V196e52 涅槃增量版：修复cc1爆破、固化1380M Swap、严格空间清理与闭环收尾】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex196e52.sh"; exit 1; fi
...
readonly SCRIPT_VERSION="196e52"
...
_compile_kernel_mainline() {
    ...
    # [核心修复] 彻底杜绝 cc1 bad value ('x86-64-v') 报错问题
...
do_kernel_compile_menu() {
    while true; do
        ...
        echo "  [已修复] cc1 bad value 编译暴毙问题 (降维兼容 GENERIC_CPU)"
...
do_sys_init_menu() {
    while true; do
        clear
        title "环境底层组件拉齐与结构重建区 (V196e52 最终版)"
...
main_menu() {
    while true; do
        clear
        echo -e "${blue}======================================================================${none}"
        echo -e "  ${magenta}Xray System Advanced Management V196e52 - (The Apex Vanguard)${none}"
...
#==============================================================================
# EOF - Apex Vanguard V196e52 System Advanced Control Ready.
#==============================================================================
