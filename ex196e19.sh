#!/usr/bin/env bash
# ==============================================================================
# 脚本名称: ex196e19.sh (The Apex Vanguard - Project Genesis V196e19)
# 快捷方式: xrv
#
# 【V196e19 终极勘误与真理重塑】
#   1. 找回丢失的灵魂: 彻底修复被吞掉的 do_sys_init_menu，主菜单 10 满血复活。
#   2. 修复 Xanmod 编译暴毙: 强制注入 CONFIG_X86_64_VERSION=1，解决 -march 拼写断层。
...
if test -z "${BASH_VERSION:-}"; then
    echo "Error: 请使用 bash 执行本脚本: bash ex196e19.sh"
    exit 1
fi
...
readonly SCRIPT_VERSION="196e19"
...
do_kernel_compile_menu() {
    while true; do
        clear
        title "极客内核源码锻造中心 (修复版)"
        echo "  由于 7.x 以上 Xanmod 引入了激进架构探测，原版容易因 -march 参数爆雷。"
        echo "  现已修复编译断层，支持三大内核分轨锻造："
        echo ""
...
main_menu() {
    while true; do
        clear
        echo -e "${blue}======================================================================${none}"
        echo -e "  ${magenta}Xray System Advanced Management V196e19 - (The Apex Vanguard)${none}"
...
# ==============================================================================
# EOF - Apex Vanguard V196e19 System Advanced Control Ready.
# ==============================================================================
# --- ✂️ Part 12 结束，所有代码拼接完毕。请运行 bash ex196e19.sh ---
