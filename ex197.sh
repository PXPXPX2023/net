#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex197.sh (The Apex Vanguard - Project Genesis V197)
# 快捷方式: xrv
# 【V197 终极融合增量版：KCFLAGS强注防cc1、官方源降维探测、主线BBR3直打、1380M死锁】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex197.sh"; exit 1; fi
...
_compile_kernel_mainline() {
    ...
    # 死锁 KCFLAGS 指令集，强制执行
    local final_march="x86-64-v${cpu_level}"
    _execute_compilation "" "KCFLAGS=\"-march=$final_march\""
}
...
_compile_kernel_xanmod() {
    ...
    # 强力注入 KCFLAGS 以绕过 Makefile 残缺语法报错
    local final_march="x86-64-v${cpu_level}"
    _execute_compilation "" "KCFLAGS=\"-march=$final_march\""
}
...
do_kernel_compile_menu() {
    while true; do
        ...
        echo "  [已修复] cc1 bad value 编译暴毙问题 (降维探针，KCFLAGS 底层强注防爆)"
...
main_menu() {
    while true; do
        clear
        echo -e "${blue}======================================================================${none}"
        echo -e "  ${magenta}Xray System Advanced Management V197 - (The Apex Vanguard)${none}"
...
#==============================================================================
# EOF - Apex Vanguard V197 System Advanced Control Ready.
#==============================================================================
