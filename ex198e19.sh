#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex198e19.sh (The Apex Vanguard - Project Genesis V198e19)
# 快捷方式: xrv
# 【V198e19 纯血救灾版：拆除致命 Boot 陷阱 + 保留全域并发 + jq/nft绝缘防卫】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex198e19.sh"; exit 1; fi
...
readonly SCRIPT_VERSION="198e19"
...
check_and_create_swap() {
    ...
    if mkswap "$SWAP_FILE" >/dev/null 2>&1; then
        ...
        # [核心修复] 强制写入 nofail，防止 BTRFS 等文件系统在开机时因为 swap 无法挂载而引发死锁
...
do_change_dns() {
    ...
    # [核心修复] 去除 chattr +i 操作，防止 DHCP 钩子无法写入从而导致重启网卡暴毙
...
do_sys_init_menu() {
    while true; do
        clear
        title "环境底层组件拉齐与结构重建区 (V198e19 终极版)"
...
main_menu() {
    while true; do
        clear
        echo -e "${blue}======================================================================${none}"
        echo -e "  ${magenta}Xray System Advanced Management V198e19 - (The Apex Vanguard)${none}"
...
main_menu
#==============================================================================
# EOF - Apex Vanguard V198e19 System Advanced Control Ready.
#==============================================================================
