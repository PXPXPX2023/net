#!/usr/bin/env bash
# ==============================================================================
# 脚本名称: ex196e15.sh (The Apex Vanguard - Project Genesis V196e15)
# 快捷方式: xrv
#
# 【V196e15 终极勘误与真理重塑】
#   1. 补全遗失函数: 找回缺失的编译函数，彻底修复 command not found 崩溃。
...
if test -z "${BASH_VERSION:-}"; then
    echo "Error: 请使用 bash 执行本脚本: bash ex196e15.sh"
    exit 1
fi
...
readonly SCRIPT_VERSION="196e15"
...
# ------------------------------------------------------------------------------
# 【V196e15 核心修复 1】：预编译官方 XANMOD 部署模块 (修复多重源与 404)
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# 【V196e15 核心修复 2】：真·三通道内核源码编译引擎 (Mainline 主线 vs Xanmod)
# ------------------------------------------------------------------------------
...
main_menu() {
    while true; do
        clear
        echo -e "${blue}======================================================================${none}"
        echo -e "  ${magenta}Xray System Advanced Management V196e15 - (The Apex Vanguard)${none}"
        ...
        echo "  10) 高级发烧：内核极客编译/网卡/系统协议栈 60余项极限配置"
...
# ==============================================================================
# EOF - Apex Vanguard V196e15 System Advanced Control Ready.
# ==============================================================================
# --- ✂️ Part 15 结束，所有代码拼接完毕。请运行 bash ex196e15.sh ---
