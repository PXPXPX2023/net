#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex196e53.sh (The Apex Vanguard - Project Genesis V196e53)
# 快捷方式: xrv
# 【V196e53 涅槃增量版：暴力斩断 Xanmod cc1 编译暴毙、绝对固化1380M Swap】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex196e53.sh"; exit 1; fi
...
readonly SCRIPT_VERSION="196e53"
...
_compile_kernel_mainline() {
    ...
    # [核心修复] 物理斩断由于 Makefile 拼接异常导致的 cc1 bad value 暴毙
...
do_kernel_compile_menu() {
    while true; do
        ...
        echo "  [已修复] cc1 bad value 编译暴毙问题 (降维兼容 GENERIC_CPU，拦截残缺参数)"
...
do_sys_init_menu() {
    while true; do
        clear
        title "环境底层组件拉齐与结构重建区 (V196e53 最终版)"
...
main_menu() {
    while true; do
        clear
        echo -e "${blue}======================================================================${none}"
        echo -e "  ${magenta}Xray System Advanced Management V196e53 - (The Apex Vanguard)${none}"
...
#==============================================================================
# EOF - Apex Vanguard V196e53 System Advanced Control Ready.
#==============================================================================
