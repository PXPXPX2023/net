#!/usr/bin/env bash
# ============================================================
# 脚本名称: g7g50x7.sh (The Apex Vanguard V5 Edition)
# 快捷方式: xrv
# 巅峰突破: 
#   1. 用户管理引入生命周期系统，新增/导入用户时自动打上时间戳并直观展示。
#   2. 外部用户导入模块升级，支持同步配置专属 SNI 并写入底层映射表。
#   3. 彻底修复 awk 提取列位 Bug，绝杀提取数字进行 TLS 质检的乌龙。
#   4. 纯净寡头节点库定稿，彻底剔除测速与华硕等高危节点。
#   5. 矩阵全量重组、十六进制防吞噬引擎、商业计费等尖端特性全量融贯。
# ============================================================

# 必须用 bash 运行
if test -z "$BASH_VERSION"; then
    echo "错误: 请用 bash 运行此脚本: bash g7g50x7.sh"
    exit 1
fi
...
run_sni_scanner() {
    ...
    www.toyota-global.com global.toyota www.honda.com global.honda www.volkswagen.com service.volkswagen.com \
    www.nike.com account.nike.com store.nike.com www.adidas.com account.adidas.com www.zara.com static.zara.net \
    www.ikea.com secure.ikea.com www.shell.com careers.shell.com www.bp.com login.bp.com www.totalenergies.com \
    www.ge.com digital.ge.com www.abb.com new.abb.com www.hsbc.com online.hsbc.com www.goldmansachs.com \
    login.gs.com www.morganstanley.com secure.morganstanley.com www.maersk.com www.msc.com www.cma-cgm.com \
    www.hapag-lloyd.com www.michelin.com www.bridgestone.com www.goodyear.com www.pirelli.com www.sony.com \
    www.sony.net www.panasonic.com www.canon.com www.nintendo.com www.lg.com www.epson.com www.unilever.com \
    www.loreal.com www.shiseido.com www.jnj.com www.kao.com www.uniqlo.com www.hermes.com www.chanel.com \
    services.chanel.com www.louisvuitton.com eu.louisvuitton.com www.dior.com www.ferragamo.com www.versace.com \
    www.prada.com www.fendi.com www.gucci.com www.tiffany.com www.esteelauder.com www.maje.com www.swatch.com \
    www.coca-cola.com www.coca-colacompany.com www.pepsi.com www.pepsico.com www.nestle.com www.bk.com \
    www.heinz.com www.pg.com www.basf.com www.bayer.com www.bosch.com www.bosch-home.com www.toyota.com \
    www.lexus.com www.vw.com www.audi.com www.porsche.com www.skoda-auto.com www.gm.com www.chevrolet.com \
    www.cadillac.com www.ford.com www.lincoln.com www.hyundai.com www.kia.com www.peugeot.com www.renault.com \
    www.jaguar.com www.landrover.com www.astonmartin.com www.mclaren.com www.ferrari.com www.maserati.com \
    www.volvocars.com www.tesla.com s0.awsstatic.com d1.awsstatic.com images-na.ssl-images-amazon.com \
    m.media-amazon.com www.nvidia.com academy.nvidia.com images.nvidia.com blogs.nvidia.com docs.nvidia.com \
    docscontent.nvidia.com www.samsung.com www.sap.com www.oracle.com www.mysql.com www.swift.com \
    download-installer.cdn.mozilla.net addons.mozilla.org www.airbnb.co.uk www.airbnb.ca www.airbnb.com.sg \
    www.airbnb.com.au www.airbnb.co.in www.ubi.com lol.secure.dyn.riotcdn.net one-piece.com"
...
fix_permissions() {
    ...
    chown nobody:nogroup "$CONFIG" >/dev/null 2>&1 || chown nobody:nobody "$CONFIG" >/dev/null 2>&1
    ...
    while true; do
        ...
        case "$s" in
            ...
            3) 
                ...
                hr
                vnstat -m 3 2>/dev/null || vnstat -m 2>/dev/null
                hr
...
EOF
    ...
    while true; do
        ...
        if [[ "$opt" == "b" || "$opt" == "B" ]]; then
            choose_sni && _safe_jq_write "(.inbounds${L_B}${R_B} | select(.protocol==\"vless\") | .streamSettings.realitySettings.serverNames) = ${L_B} $SNI_JSON_ARRAY ${R_B} | (.inbounds${L_B}${R_B} | select(.protocol==\"vless\") | .streamSettings.realitySettings.dest) = \"$BEST_SNI:443\"" && systemctl restart xray >/dev/null 2>&1 && do_summary
        else
            break
        fi
    done
...
main_menu() {
    while true; do
        clear
        echo -e "${blue}===================================================${none}"
        echo -e "  ${magenta}Xray G7G50x7 The Apex Vanguard V5 Edition${none}"
