#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex198e90.sh (The Apex Vanguard - Project Genesis V198e89)
# 快捷方式: xrv
# 【V198e90 三协议稳态版：e88/e89基线 + BBR内置/模块双路线替换中心】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex198e88.sh"; exit 1; fi
...
readonly SCRIPT_VERSION="198e90"
...
#==============================================================================
# EOF - Apex Vanguard V198e90 BBR Builtin/Module Body Replace Ready.
#==============================================================================
