#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex198e9.sh (The Apex Vanguard - Project Genesis V198e9)
# 快捷方式: xrv
# 【V198e9 终极版：上帝视角 RTT 探针、initcwnd 动态拥塞窗口扩容、开机固化防线】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex198e9.sh"; exit 1; fi
...
do_perf_tuning() {
    ...
    local latency=$(ss -ti 2>/dev/null | grep "rtt:" | awk -F 'rtt:' '{print $2}' | awk -F '/' '{print $1}' | awk '{ total += $1; count++ } END { if (count > 0) print int(total/count); else print 150 }' || echo "150")
...
do_sys_init_menu() {
    while true; do
        clear
        title "环境底层组件拉齐与结构重建区 (V198e9 终极版)"
...
main_menu() {
    while true; do
        clear
        echo -e "${blue}======================================================================${none}"
        echo -e "  ${magenta}Xray System Advanced Management V198e9 - (The Apex Vanguard)${none}"
...
#==============================================================================
# EOF - Apex Vanguard V198e9 System Advanced Control Ready.
#==============================================================================
