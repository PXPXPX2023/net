#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex198e96.sh (The Apex Vanguard - Project Genesis V198e96)
# 快捷方式: xrv
# 【V198e96 三协议稳态版：e95基线 + BBR模块源码自动补齐 + 统一TC接管】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex198e96.sh"; exit 1; fi
...
readonly SCRIPT_VERSION="198e96"
