#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex198e93.sh (The Apex Vanguard - Project Genesis V198e92)
# 快捷方式: xrv
# 【V198e93 三协议稳态版：e92基线 + 跨境链路诊断中心 + TC带宽控制热更新】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex198e93.sh"; exit 1; fi
...
readonly SCRIPT_VERSION="198e93"
