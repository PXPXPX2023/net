#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex198e16.sh (The Apex Vanguard - Project Genesis V198e16)
# 快捷方式: xrv
# 【V198e16 终极纯血版：e8完美内核编译系统 + 上帝视角动态拥塞扩容 + MSS/reusePort】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex198e16.sh"; exit 1; fi
...
readonly SCRIPT_VERSION="198e16"
