#!/usr/bin/env bash
#==============================================================================
# 脚本名称: ex198e92.sh (The Apex Vanguard - Project Genesis V198e92)
# 快捷方式: xrv
# 【V198e92 三协议稳态版：e91基线 + 安全审计/Top20复测/JSON写入审计/启动防砖热更新】
#==============================================================================
if test -z "${BASH_VERSION:-}"; then echo "Error: 请使用 bash 执行本脚本: bash ex198e92.sh"; exit 1; fi
...
readonly SCRIPT_VERSION="198e92"
